...
pub fn config() -> LevelConfig {
    ...
    LevelConfig {
        ...
        hints: vec![
            ...
            "Top line: belts -> smelter -> SPLITTER (i then b) to duplicate ingots into BOTH assembler inputs -> belts to the bin.",
            "Working? Esc to Normal mode. The cluster is ~4 rows tall: put the cursor on its TOP row and press 4yy to yank all 4 rows.",
            "Jump down to the next cluster (6j to its top row), press p to paste. Repeat for the third cluster.",
